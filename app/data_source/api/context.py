...
class DataSourceContext:
    ...
    @classmethod
    async def create_data_source(cls, name: str, config: dict, organization_id: int) -> BaseDataSource:
        async with async_session() as session:
            ...
            data_source_row = DataSource(type_id=data_source_type.id, config=config_str, created_at=get_utc_time_now(), organization_id=organization_id)
