...
class ConfluenceDataSource(BaseDataSource):
    ...
    @staticmethod
    def confluence_client_from_config(parsed_config: ConfluenceConfig) -> Confluence:
    ...
    def __init__(self, *args, **kwargs):
        ...
        parsed_config = ConfluenceConfig(**self._raw_config)
        self._confluence = ConfluenceDataSource.confluence_client_from_config(parsed_config)
        self.namespace = parsed_config.namespace
